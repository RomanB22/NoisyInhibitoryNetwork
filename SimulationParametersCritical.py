...
simulationEnd = 1300*b2.ms#1900*b2.ms #Time of simulation end
...
#Conductance based
sigmaAux = np.sort( np.concatenate( (np.around(np.linspace(10.011,15.011,11,endpoint=True),4),np.around(np.linspace(0.011,10.011,51, endpoint=True),4)) ) )
JAux = [1.,20.,40.]#[1.,20.,40.,60.,80.,100.,120.,140.,160.,180.,250.,300.]
I0Aux= [60.,75.]#[50.,55.,60.,65.,70.,75.,80.]

# Izhi Type II
#sigmaAux = np.around(np.linspace(0.011,10.011,51, endpoint=True),4)
#JAux = [20.]#[1.,20.,40.,60.,80.,100.,120.,140.,160.,180.,250.,300.]
#I0Aux= [20.]#[0.,10.,20.]#[0.,10.,20.,30.,40.,50.]#[30.,40.,45.,50.,55.,60.,65.,70.,75.,80.]

...
SimuIdentifier2 = '*sigma=0.1122*N=3000*nu0=30*'

ISII0_10 = glob.glob(Folder + 'ISI'+ '*J=7.9' + SimuIdentifier1)
PopRateI0_10 = glob.glob(Folder + 'PopRate'+ '*J=7.9' + SimuIdentifier1)
RasterI0_10 = glob.glob(Folder + 'Raster'+ '*J=7.9' + SimuIdentifier1)
CurrentI0_10 = glob.glob(Folder + 'FullMonitor'+ '*J=7.9' + SimuIdentifier1)

ISII0_19 = glob.glob(Folder + 'ISI'+ '*J=148.' + SimuIdentifier2)
PopRateI0_19 = glob.glob(Folder + 'PopRate'+ '*J=148.' + SimuIdentifier2)
RasterI0_19 = glob.glob(Folder + 'Raster'+ '*J=148.' + SimuIdentifier2)
CurrentI0_19 = glob.glob(Folder + 'FullMonitor'+ '*J=148.' + SimuIdentifier2)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux10+4.707, 'g',label='Total')
ax3.plot(t, 4.707 + np.mean(Inotnoisy_0Aux10) *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
...
ax1 = plt.gca()
l = plt.hist(ISIAux19, bins=np.arange(20,80,1), histtype='stepfilled',range=(min(ISIAux19)*0.99,max(ISIAux19)*1.01), density=True, color='tab:blue' )			
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux19+2.8125, 'g',label='Total')
ax3.plot(t, 2.8125 + np.mean(Inotnoisy_0Aux19) *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'r--')
ax3.text(xcoordinate, ycoordinateSN, "SN", fontsize=11)
ax3.plot(t, AH*np.ones(np.shape(t)), 'r--')
ax3.text(xcoordinate, ycoordinateAH, "AH", fontsize=11)

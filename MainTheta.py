...
execfile("SimulationParametersTheta.py")
execfile("AuxiliarFunctionsTheta.py")
execfile("NeuronModelsTheta.py")
...
PlotFile2 = WorkingDirectory + FiguresFolder + SimuIdentifier +"_"+ ExcInhTheta+ ".svg"
print(PlotFile2)
# Izhi Type I
...
# Izhi Type II
CreatePlot2DModel(simulationEnd,ISI_times,SpikeMon,VarMon,PlotFile2,N,IntervalLong=PlotingTime,NeuronIndex=0,v_th=v_th, num_bins = 30, Theta=ThetaInput, ChosenModel=ChosenModel)
print('Done!')
print("################################################################################")

...
ChosenModel = 5 #Models = {0:'IzhiTypeI', 1:'IzhiTypeII', 2:'LIFModel', 3:'AdExModel', 4:'GuillemModel', 5:'IzhiTypeIIModified'}
ChosenSubmodelAdEx = 2 #SubModelsAdEx = {0:'TypeI', 1:'TypeIISaddleNode', 2:'TypeIIAndronovHopf'}
ThetaInput = False
FirstBisection = True # First run calculating Iext for N=800. This results serve as input for the second bisection search
...
simulationEnd = 1800*b2.ms#2400*b2.ms #Time of simulation end
...
# For IzhiType I 30 Hz
#sigmaAux = [0.2239,1.0593,4.0110,9.5110]
#JAux = [1.3,10.0,20.0,50.1,100.0,148.0]
# For IzhiType II 30 Hz
#sigmaAux = [0.2239,0.5110,0.7610,1.0593,3.0110,4.0110,6.5110,7.0110,9.5110]
#JAux = [1.3,5.0,10.0,20.0,50.1,100.0,148.0]

...
execfile("SimulationParametersSolveI0.py")
...
if FirstBisection:
	if ChosenModel==4: #Via model
		I0_solution = bisectionSearch(I0_init=0.*IextUnits,I0_end=200.*IextUnits,Nu_0=Nu_0, DeltaNu_0=DeltaNu_0,I0_lowbound=-600.*IextUnits,I0_uppbound=600.*IextUnits,maxIter=30,I0Units=IextUnits,transientTime=transientTime)/IextUnits
	elif ChosenModel==3: #AdEx model
		I0_solution = bisectionSearch(I0_init=0.*IextUnits,I0_end=40.*IextUnits,Nu_0=Nu_0, DeltaNu_0=DeltaNu_0,I0_lowbound=0.*IextUnits,I0_uppbound=100.*IextUnits,I0Units=IextUnits,transientTime=transientTime)/IextUnits
	...
	elif ChosenModel==5: #Izhikeivch Type 2 resonator model Modified
		I0_solution = bisectionSearch(I0_init=0*IextUnits,I0_end=40*IextUnits,Nu_0=Nu_0, DeltaNu_0=DeltaNu_0,I0_lowbound=-50.*IextUnits,I0_uppbound=100.*IextUnits,I0Units=IextUnits,transientTime=transientTime)/IextUnits
else:
	Iext_Guess = LoadMatrixI0(J,sigma,I0Folder,SimuIdentifier="MatrixI0JSigma" + I0Folder[3:-1] + str(int(ParameterList[5])) + "Hz"+ "_N" + str( PreviousN(N,NAux2) ))*IextUnits

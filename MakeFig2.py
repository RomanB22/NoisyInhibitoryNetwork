...
ISII0_19 = glob.glob(Folder + 'ISI'+ SimuIdentifier1 + '2.0110' + SimuIdentifier2)
PopRateI0_19 = glob.glob(Folder + 'PopRate'+ SimuIdentifier1 + '2.0110' + SimuIdentifier2)
RasterI0_19 = glob.glob(Folder + 'Raster'+ SimuIdentifier1 + '2.0110' + SimuIdentifier2)
CurrentI0_19 = glob.glob(Folder + 'FullMonitor'+ SimuIdentifier1 + '2.0110' + SimuIdentifier2)

ISII0_31 = glob.glob(Folder + 'ISI'+ SimuIdentifier1 + '9.5110' + SimuIdentifier2)
PopRateI0_31 = glob.glob(Folder + 'PopRate'+ SimuIdentifier1 + '9.5110' + SimuIdentifier2)
RasterI0_31 = glob.glob(Folder + 'Raster'+ SimuIdentifier1 + '9.5110' + SimuIdentifier2)
CurrentI0_31 = glob.glob(Folder + 'FullMonitor'+ SimuIdentifier1 + '9.5110' + SimuIdentifier2)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux10*0.09/10+26.875*0.09/10, 'g',label='Total')
ax3.plot(t, 26.875*0.09/10 + np.mean(Inotnoisy_0Aux10)*0.09/10 *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'r-')
#plt.legend()
ax3.text(xcoordinate, ycoordinate, "SN", fontsize=6)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux19*0.09/10+32.34375*0.09/10, 'g',label='Total')
ax3.plot(t, 32.34375*0.09/10 + np.mean(Inotnoisy_0Aux19)*0.09/10 *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'r--')
#plt.legend()
ax3.text(xcoordinate, ycoordinate, "SN", fontsize=6)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux31*0.09+43.76953125*0.09/10, 'g',label='Total')
ax3.plot(t, 43.76953125*0.09/10 + np.mean(Inotnoisy_0Aux31)*0.09 *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'r--')
#plt.legend()
ax3.text(xcoordinate, ycoordinate, "SN", fontsize=6)

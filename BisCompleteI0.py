...
if Indexes.size == 0:
	...
	Iext_Guess = np.unique(Matrix[tree.query([J/b2.mV,sigma/b2.mV])[1],0])*IextUnits

	I0_solution = bisectionSearch(I0_init=Iext_Guess-1.*abs(Iext_Guess),I0_end=Iext_Guess+1.*abs(Iext_Guess),Nu_0=Nu_0, DeltaNu_0=DeltaNu_0,I0_lowbound=0.*IextUnits,I0_uppbound=80.*IextUnits,I0Units=IextUnits,transientTime=transientTime,maxIter=50)/IextUnits
else:	

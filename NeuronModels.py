...
For Theta-Nested Iext*(0.7+0.3*sin(2*pi*f*t)) Test2: Iext*(0.5+0.5*sin(2*pi*f*t))
...
TotalInput = " + Iext/tau_m + RecurrentInput/tau_m + sigma/sqrt(tau_m)*xi : volt" + "\n" + "RecurrentInput = - J/N * stot : volt"+"\n"+"stot : 1"+"\n"+"Iext : volt"
...
base_eqs = gat_vars + ext_eqs + param_eqs;

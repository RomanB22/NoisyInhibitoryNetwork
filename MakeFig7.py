...
ISII0_19 = glob.glob(Folder + 'ISI'+ SimuIdentifier1 + '0.891' + SimuIdentifier2)
PopRateI0_19 = glob.glob(Folder + 'PopRate'+ SimuIdentifier1 + '0.891' + SimuIdentifier2)
RasterI0_19 = glob.glob(Folder + 'Raster'+ SimuIdentifier1 + '0.891' + SimuIdentifier2)
CurrentI0_19 = glob.glob(Folder + 'FullMonitor'+ SimuIdentifier1 + '0.891' + SimuIdentifier2)

ISII0_31 = glob.glob(Folder + 'ISI'+ SimuIdentifier1 + '1.5110' + SimuIdentifier2)
PopRateI0_31 = glob.glob(Folder + 'PopRate'+ SimuIdentifier1 + '1.5110' + SimuIdentifier2)
RasterI0_31 = glob.glob(Folder + 'Raster'+ SimuIdentifier1 + '1.5110' + SimuIdentifier2)
CurrentI0_31 = glob.glob(Folder + 'FullMonitor'+ SimuIdentifier1 + '1.5110' + SimuIdentifier2)
...
t, v_0Aux19,v_1Aux19,v_2Aux19,v_3Aux19,v_4Aux19, u_0Aux19,u_1,u_2,u_3,u_4, Inotnoisy_0Aux19,InN_1,InN_2,InN_3,InN_4 = np.loadtxt(CurrentI0_19[0],comments='#',skiprows=1,unpack=True)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux10+3.10546875, 'g',label='Total')
ax3.plot(t, 3.10546875 + np.mean(Inotnoisy_0Aux10) *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux19+4.248046875, 'g',label='Total')
ax3.plot(t, 4.248046875 + np.mean(Inotnoisy_0Aux19) *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'r--')
ax3.text(xcoordinate, ycoordinateSN, "SN", fontsize=11)
ax3.plot(t, AH*np.ones(np.shape(t)), 'r--')
ax3.text(xcoordinate, ycoordinateAH, "AH", fontsize=11)
...
ax1 = plt.gca()
xlim_right=tmax#tSpikes31[-1]
xlim_left=tSpikes31[np.argmin(abs(tSpikes31-tmin))]
Npoints = int((xlim_right-xlim_left)/Timestep) # Timestep 1 ms 
bin_edges = np.linspace(xlim_left, xlim_right,Npoints+1,endpoint=True)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux31+5.69335863, 'g',label='Total')
ax3.plot(t, 5.69335863 + np.mean(Inotnoisy_0Aux31) *np.ones(np.shape(t)), 'b', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'r--')
ax3.text(xcoordinate, ycoordinateSN, "SN", fontsize=11)
ax3.plot(t, AH*np.ones(np.shape(t)), 'r--')
ax3.text(xcoordinate, ycoordinateAH, "AH", fontsize=11)
...
plt.savefig("FigureCOtoSPO.svg")
plt.savefig("FigureCOtoSPO.eps")

...
Folder = '../CSV_IzhiTyI/*'
SimuIdentifier = '*sigma=7.5110*N=3000*nu0=17*'

ISII0_10 = glob.glob(Folder + 'ISI'+ '*J=1.' + SimuIdentifier)
PopRateI0_10 = glob.glob(Folder + 'PopRate'+ '*J=1.' + SimuIdentifier)
RasterI0_10 = glob.glob(Folder + 'Raster'+ '*J=1.' + SimuIdentifier)
CurrentI0_10 = glob.glob(Folder + 'FullMonitor'+ '*J=1.' + SimuIdentifier)

ISII0_19 = glob.glob(Folder + 'ISI'+ '*J=113.' + SimuIdentifier)
PopRateI0_19 = glob.glob(Folder + 'PopRate'+ '*J=113.' + SimuIdentifier)
RasterI0_19 = glob.glob(Folder + 'Raster'+ '*J=113.' + SimuIdentifier)
CurrentI0_19 = glob.glob(Folder + 'FullMonitor'+ '*J=113.' + SimuIdentifier)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux10+12.34375, 'k-',label='Total')
ax3.plot(t, 12.34375 + np.mean(Inotnoisy_0Aux10) *np.ones(np.shape(t)), 'k--', linewidth=0.5,label='Mean')
...
plt.title('B1 - J=113 mV',loc='left')
plt.ylabel('Counts')
ax1.spines['top'].set_visible(False)
ax1.spines['right'].set_visible(False)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux19+31.09375, 'k-',label='Total')
ax3.plot(t, 31.09375 + np.mean(Inotnoisy_0Aux19) *np.ones(np.shape(t)), 'k--', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'k-.')
plt.legend()
ax3.text(xcoordinate, ycoordinate, "SN", fontsize=11)
...
ax3 = plt.gca()
ax3.plot(t, Inotnoisy_0Aux31+36.1328125, 'k-',label='Total')
ax3.plot(t, 36.1328125 + np.mean(Inotnoisy_0Aux31) *np.ones(np.shape(t)), 'k--', linewidth=0.5,label='Mean')
ax3.plot(t, SN*np.ones(np.shape(t)), 'k-.')
plt.legend()
ax3.text(xcoordinate, ycoordinate, "SN", fontsize=11)
